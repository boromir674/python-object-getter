...
# builds the documentation pages of the Python Object Getter
# project.
...
def get_templated_vars():
    return type('TemplatedVariables', (), dict(
        project_slug='python-object-getter',
        package_name='python_object_getter',
        author_name='Konstantinos Lampridis',
        year='2022',
        version='0.0.1',
        github_username='boromir674',
        repo_name='python-object-getter',
    ))
