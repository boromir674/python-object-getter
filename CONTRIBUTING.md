...
Report bugs at [https://github.com/boromir674/python-object-getter/issues](https://github.com/boromir674/python-object-getter/issues).
W
Stambling upon a Bug means encountering different behaviour than the expected/advertised one. When you are reporting a bug, please include the following infromation by filling in [the template](https://github.com/boromir674/python-object-getter/.github/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
Python Object Getter could always use more documentation, whether as part of the official Python Object Getter docs, in docstrings, etc.
...
The best way to send feedback is to file an issue at [https://github.com/boromir674/python-object-getter/issues](https://github.com/boromir674/python-object-getter/issues).
...
Here's how to set up `python-object-getter` for local development.

1. Fork the `python-object-getter` repo on GitHub.
2. Clone your fork locally:

```bash
git clone git@github.com:boromir674/python-object-getter.git
cd python-object-getter
```
...
Python Object Getter is designed to do one thing, and do that one thing very well.
...
The roadmap located [here](https://github.com/boromir674/python-object-getter/milestones?direction=desc&sort=due_date&state=open)
